...
public class P08_BuildInLocators {
    public static void main(String[] args) throws InterruptedException {
        ...
        //getByPlaceHolder
        page.getByPlaceholder("Telefon Numarası").fill("905882536358"); // kutu içerisine telefon numarasi gonderdik
        Thread.sleep(2000);


        //getBYTestId
        page.getByTestId("button").last().click(); //butona tıklama (last.click kullanmamnın nedeni button elementinin birden fazla olması. last ile sonuncusuna tikla dedik.
        Thread.sleep(2000);
